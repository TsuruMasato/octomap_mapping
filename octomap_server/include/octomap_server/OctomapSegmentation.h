...
public:
  ...
  void set_private_octree(octomap_server::OctomapServer::OcTreeT *&input_octree) { private_octomap_ = input_octree; };
  ...
  void add_handrail_marker(pcl::ModelCoefficients cylinder_coefficient, int &marker_id, visualization_msgs::MarkerArray &marker_array, const std::string &frame_id);
...
private:
  octomap_server::OctomapServer::OcTreeT* private_octomap_;
